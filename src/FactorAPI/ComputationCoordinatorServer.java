...
public class ComputationCoordinatorServer { // Boilerplate: Changed name of class
    ...
    public static void main(String[] args) throws Exception {
        ComputationCoordinatorServer server = new ComputationCoordinatorServer(); // Boilerplate: Changed name of class
        server.start();
